...
ru:{
 ...
 commandTip:'Нажмите команду для немедленной отправки. Команды со значением вводите вручную:',footer:'независимый community-проект. Проверяйте частоту, распиновку и модель платы перед прошивкой.',
...
en:{
 ...
 commandTip:'Click a command to send it immediately. Commands with values can be entered manually:',footer:'independent community project. Verify frequency, pinout and board model before flashing.',
...
kk:{
 ...
 commandTip:'Команданы бірден жіберу үшін басыңыз. Мәні бар командаларды қолмен енгізіңіз:',footer:'тәуелсіз community-жоба. Прошивка алдында жиілікті, pinout пен плата моделін тексеріңіз.',
...
const builds=[
 {id:'sensor-sx1278',board:'diy-promicro',name:'SENSOR · SX1278',desc:{ru:'Endpoint telemetry SENSOR с GPS, discovery и sensor scan.',en:'Endpoint telemetry SENSOR with GPS, discovery and sensor scan.',kk:'GPS, discovery және sensor scan бар SENSOR endpoint.'},tags:['nRF52840','SX1278','SENSOR'],file:'firmware/nrf52840/sensor-sx1278.uf2',ready:true},
 {id:'companion-sh1106',board:'diy-promicro',name:'Companion · SH1106',desc:{ru:'Companion с SH1106, кириллицей, историей сообщений и one-button UI.',en:'Companion with SH1106, Cyrillic rendering, message history and one-button UI.',kk:'SH1106, Cyrillic, хабар тарихы және one-button UI бар Companion.'},tags:['nRF52840','SX1278','SH1106'],file:'firmware/nrf52840/companion-sx1278-sh1106.uf2',ready:true},
 {id:'companion-ssd1306',board:'diy-promicro',name:'Companion · SSD1306',desc:{ru:'Companion для SSD1306 display profile.',en:'Companion build for SSD1306 display profile.',kk:'SSD1306 display profile үшін Companion.'},tags:['nRF52840','SX1278','SSD1306'],file:'firmware/nrf52840/companion-sx1278-ssd1306.uf2',ready:true},
 {id:'repeater-sx126x',board:'diy-promicro',name:'Repeater · E22 / SX126x 433',desc:{ru:'Repeater для nRF52840 + E22/SX126x 433/434 MHz.',en:'Repeater for nRF52840 + E22/SX126x 433/434 MHz.',kk:'nRF52840 + E22/SX126x 433/434 MHz үшін Repeater.'},tags:['nRF52840','SX126x','433/434'],file:'firmware/nrf52840/repeater-sx126x-433.uf2',ready:true}
];
...
function showBuild(build,button){
 ...
 selected.classList.remove('hidden');nameEl.textContent=build.name;descEl.textContent=build.desc[lang];meta.textContent=build.tags.join(' · ');
