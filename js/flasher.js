...
const boards=[
 {id:'fnk0104b',name:'Freenove FNK0104B',vendor:'Freenove / WadaMesh',chip:'ESP32-S3',group:['esp32','espnow'],status:'ready',icon:'🖥️',desc:{ru:'Touchscreen-устройство WadaMesh с ESP-NOW, BLE, Wi-Fi, картами и приложениями.',en:'WadaMesh touchscreen device with ESP-NOW, BLE, Wi-Fi, maps and apps.',kk:'ESP-NOW, BLE, Wi-Fi, карталар және қолданбалар бар WadaMesh touchscreen құрылғысы.'}},
